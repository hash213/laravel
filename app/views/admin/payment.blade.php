...
<div class="top-div2">
  ...
  <h2>Date: {{$date}}</h2>
{{Form::hidden('data',$payment->approval->term)}}
{{Form::hidden('pid',$payment->id)}}
<input type="hidden" name="" id="balance" value="{{$balance->balance}}">
...
<div class="">
   ...
   <!--  {{Form::text('approvedDate',date('F j, Y'))}} -->
    ...
    <div class="col-lg-4">
      <label>Amortization Type:{{$payment->amortization_type}}</label>
    </div>
    
    
    <div class="col-lg-4">
      <label>Balance:{{$balance->balance}}</label>
    </div>
 
 

    <div class="col-lg-4">
      <label>Amortization starts: {{$payment->release->datereleased}}</label>
    </div>
    <div class="col-lg-4">
      <label>Next Amortization: {{$ndate}}</label>
    </div>
  </div> 
</div> 
  ...
  <div class="form-horizontal ">
    ...
    <h2 class="font text-center">
      ...
      <div class="col-lg-4">
        ...
        {{Form::text('payments',$payment->approval->amortization,['class'=>'form-control form-field','id'=>'amortization'])}}
      </div>
      </div>
    </div>
    <form name="form1">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
      ...
      <div class="form-horizontal">
        ...
        <div class="col-lg-5">
        <input name="balance" id="balance2" value="{{$balance->balance}}" type="text" class="form-control form-field">
        </div>
        </div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
      ...
      <div class="form-horizontal">
        ...
        <label for="" class="col-lg-5 control-label">Balance:</label>
        <div class="col-lg-5">
        <input name="appGrossIncome" id="bal" value="{{$balance->balance}}" type="text" class="form-control form-field">
        </div>
        </div>
