...
<div class="top-div2">
  ...
  <h2>Date: {{$date}}</h2>
{{Form::hidden('data',$payment2->approval->term)}}
{{Form::hidden('pid',$payment2->id)}}
<input type="hidden" name="" id="balance" value="{{$payment2->balance->balance}}">
...
<div class="">
   ...
   <!--  {{Form::text('approvedDate',date('F j, Y'))}} -->
    <div class="col-lg-4">
      <label>Name:  {{$payment2->fname}} {{$payment2->lname}}</label>
      </div>
    
    
    <div class="col-lg-4">
      <label>Loan Amount:  {{$payment2->approval->approvedAmount}}</label>
    </div>
   
   
    <div class="col-lg-4">
      <label>Amortization: {{$payment2->approval->amortization}}</label>
    </div>
  
   
    <div class="col-lg-4">
      <label>Amortization Type:{{$payment2->amortization_type}}</label>
    </div>
    
    
    <div class="col-lg-4">
      <label>Balance:{{$payment2->balance->balance}}</label>
    </div>
 
 

    <div class="col-lg-4">
      <label>Amortization starts: {{$payment2->release->datereleased}}</label>
    </div>
    <div class="col-lg-4">
      <label>Next Amortization: {{$ndate2}}</label>
    </div>
  </div> 
</div> 
  ...
  <div class="form-horizontal ">
    ...
    <h2 class="font text-center">
      ...
      <div class="col-lg-4">
        ...
        {{Form::text('payments',$payment2->approval->amortization,['class'=>'form-control form-field','id'=>'amortization'])}}
      </div>
      </div>
    </div>
    <form name="form1">
    ...
    <div class="col-lg-11 ">
      ...
      <input type="text" name="penalty" value="0" class="form-control" id="penalty">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
      ...
      <div class="form-horizontal">
        ...
        <div class="col-lg-5">
        <input name="balance" id="balance2" value="{{$payment2->balance->balance}}" type="text" class="form-control form-field">
        </div>
        </div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-body">
      ...
      <div class="form-horizontal">
        ...
        <label for="" class="col-lg-5 control-label">Balance:</label>
        <div class="col-lg-5">
        <input name="appGrossIncome" id="bal" value="{{$payment2->balance->balance}}" type="text" class="form-control form-field">
        </div>
        </div>
